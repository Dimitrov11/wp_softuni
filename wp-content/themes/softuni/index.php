            ...
            <div class="col-sm-4">
                <div class="porduct-box">
                    <img class="img-responsive" 
                        src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/product-1.jpg' ); ?>" alt="product">
                    <h3 class="product-title">Space robot</h3>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="porduct-box">
                    <img class="img-responsive" src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/product-2.jpg '); ?>" alt="product">
                    <h3 class="product-title">Sports robot</h3>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="porduct-box">
                    <img class="img-responsive" src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/product-3.jpg'); ?>" alt="product">
    ...
    <div class="container section-bg">
        ...
        <div class="row">
            <div class="boxed">
                ...
                <div class="col-sm-12">
                    <img class="img-responsive" src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/history.png'); ?>" alt="history">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="boxed">
                <div class="col-sm-12">
                    <div id="partner-slider" class="owl-carousel">
                        <div class="item">
                            <img src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/6.png'); ?>" alt="partner">
                        </div>
                        <div class="item">
                            <img src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/7.png'); ?>" alt="partner">
                        </div>
                        <div class="item">
                            <img src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/8.png'); ?>" alt="partner">
                        </div>
                        <div class="item">
                            <img src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/9.png'); ?>" alt="partner">
                        </div>
                        <div class="item">
                            <img src="<?php echo home_url( 'wp-content/themes/softuni/assets/images/6.png'); ?>" alt="partner">
                        </div>
